...
@php
    ...
    // dd($Advisor->networks);
    // dd($Advisor_Networks);
    $educations = json_decode($Advisor->education , true);
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-8 mx-auto">
            ...
            <form class="" action="{{ route('Admins.Advisors.update' , $id) }}" method="post" novalidate>
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            ...
                            <div class=" col-sm-8"> <input class="form-control" name="name" type="text"
                                    value="{{ $Advisor->name }}" placeholder="نام و نام خانوادگي">
                        ...
                        <div class="row form-group">
                            ...
                            <div class=" col-sm-8"><input class="form-control" name="username" type="text"
                                    value="{{ $Advisor->username }}" placeholder="نام كاربري">
                                <span class="text-danger mt-1 d-block">
                                    @error('username')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="row form-group">
                            ...
                            <div class=" col-sm-8"><input class="form-control" name="email" type="email"
                                    value="{{ $Advisor->email }}" placeholder="ایمیل">
                                <span class="text-danger mt-1 d-block">
                                    @error('email')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="row form-group">
                            ...
                            <div class=" col-sm-8"><input class="form-control" name="mobile" type="text"
                                    value="{{ $Advisor->mobile }}" placeholder="شماره موبايل">
                                <span class="text-danger mt-1 d-block">
                                    @error('mobile')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="row form-group">
                            ...
                            <div class=" col-sm-8"> <input class="form-control" name="tel" type="text"
                                    value="{{ $Advisor->tel }}" placeholder="تلفن ثابت">
                                <span class="text-danger mt-1 d-block">
                                    @error('tel')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="row form-group">
                            ...
                            <div class=" col-sm-8"> <input class="form-control" name="address" type="text"
                                    value="{{ $Advisor->address }}" placeholder="آدرس محل کار">
                                <span class="text-danger mt-1 d-block">
                                    @error('address')
                                    {{ $message }}
                                    @enderror
                    ...
                    <form class="bio-form" action="{{ route('Advisors.ProfileBio.update') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="resume" class="form-control"
                                placeholder="لطفا سابقه ی فعالیت خود را بنویسید.">{{ $Advisor->resume }}</textarea>
                        </div>
