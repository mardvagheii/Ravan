                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('Admins.SubjectCategories.edit' , $item->id ) }}"
                                    class="d-inline-block my-1  btn btn-primary"><i class="fa fa-edit"></i></a>
                                <a href="#" class="delete btn btn-danger"
                                    data-url="{{route('Admins.SubjectCategories.destroy','Delete')}}" data-type="table"
