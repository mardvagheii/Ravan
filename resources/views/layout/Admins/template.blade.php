        ...
        <div class="side-menu-body">
            <ul>
                ...
                <li><a><i class="icon ti-list"></i>
                    ...
                    <ul>
                        <li><a href="{{ route('Admins.Category') }}">لیست</a></li>
                        <li><a href="{{ route('Admins.Category.create') }}">ایجاد</a></li>
                ...
                <li><a><i class="icon ti-agenda"></i>
                        <span>مقالات</span></a>
                    <ul>
                        <li><a href="{{ route('Admins.Blogs.index') }}">لیست</a></li>
                        <li><a href="{{ route('Admins.Blogs.create') }}">ایجاد</a></li>
