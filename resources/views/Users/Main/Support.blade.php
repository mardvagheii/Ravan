...
@section('title', 'داشبورد')
    ...
    $Supports= \App\Models\Support::where(['user_id'=>$user->id,'type_user'=>'web'])->get();
    @endphp
@section('content')
                    ...
                    <div class="chat-sidebar-messages"
                        ...
                        <div class="list-group">
                            @forelse ($Supports as $item)
                                <a href="#" data-id="{{$item->id}}" data-url="{{route('Users.Supports.show','id')}}" class="list-group-item align-items-center d-flex list-group-item-action open-ct">
                                    <div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <form action="{{route('Users.Supports.store')}}" method="post">
                <input type="hidden" name="type_user" value="web">
                @csrf
